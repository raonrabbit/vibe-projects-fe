...
const config = {
    ...
    theme: {
        extend: {
            ...
            fontSize: {
                ...
                sm: [
                    "0.875rem",
                    { lineHeight: "1.375rem", letterSpacing: "-0.01em" },
                ],
                base: [
                    "1rem",
                    { lineHeight: "1.625rem", letterSpacing: "-0.011em" },
                ],
                lg: [
                    "1.125rem",
                    { lineHeight: "1.75rem", letterSpacing: "-0.014em" },
                ],
                xl: [
                    "1.25rem",
                    { lineHeight: "1.875rem", letterSpacing: "-0.017em" },
                ],
                "2xl": [
                    "1.5rem",
                    { lineHeight: "2.125rem", letterSpacing: "-0.019em" },
                ],
                "3xl": [
                    "1.875rem",
                    { lineHeight: "2.375rem", letterSpacing: "-0.021em" },
                ],
                "4xl": [
                    "2.25rem",
                    { lineHeight: "2.75rem", letterSpacing: "-0.022em" },
                ],
                "5xl": [
                    "3rem",
                    { lineHeight: "3.375rem", letterSpacing: "-0.03em" },
                ],
            },
            borderRadius: {
                sm: "0.25rem",
    ...
    plugins: [plugin(({ addComponents }) => addComponents(typeScale))],
} satisfies Config;
