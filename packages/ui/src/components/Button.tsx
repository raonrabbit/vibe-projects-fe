      ...
      <button
        ...
        className={cn(
          ...
          'disabled:pointer-events-none disabled:opacity-40',
          {
            ...
            'bg-surface-raised text-text-primary border border-border hover:bg-surface-overlay': variant === 'secondary',
            'text-text-secondary hover:text-text-primary hover:bg-surface-raised':             variant === 'ghost',
            'bg-error text-error-foreground hover:opacity-90':                                 variant === 'destructive',
          },
          {
