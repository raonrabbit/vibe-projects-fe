...
const WindowScene = dynamic(
    () => import("@/widgets/window-view/ui/WindowScene"),
    { ssr: false },
);
...
export default function BoardingPage() {
    ...
    return (
        <>
            {/* WindowScene preloader — fixed behind boarding, revealed as boarding fades */}
            <div
                aria-hidden
                style={{
                    position: "fixed",
            ...
            <main
                className="relative min-h-screen bg-fr-base overflow-hidden"
                style={{
                    position: "relative",
                    zIndex: 2,
                    animation: takingOff
