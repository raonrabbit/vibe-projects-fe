...
import { Badge, Card, ChevronRightIcon } from "@/shared/ui";
...
const NEWS_LIST: {
...
}[] = [
  {
    ...
    title:
      "Claude 4로 뉴스 요약 파이프라인 구축하기 — 단일 API 호출로 비용 최소화",
    source: "toss.tech",
    time: "1시간 전",
  },
  {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/news"
          className="type-label-1 text-accent transition-colors hover:text-accent-hover"
        >
          전체 보기 →
        </Link>
      </div>
            ...
            <li key={i}>
              ...
              >
                <div className="min-w-0 flex-1 space-y-1.5">
                  ...
                  <p className="line-clamp-2 type-headline-2 text-text-primary">
                    {item.title}
                  </p>
                </div>
                <ChevronRightIcon
